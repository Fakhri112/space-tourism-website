...
import imgDskt from "../../assets/destination/background-destination-desktop.jpg";
import imgTblt from "../../assets/destination/background-destination-tablet.jpg";
import imgMbl from "../../assets/destination/background-destination-mobile.jpg";
